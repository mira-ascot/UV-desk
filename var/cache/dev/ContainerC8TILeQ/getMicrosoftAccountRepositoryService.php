 ...
 */
class getMicrosoftAccountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAccountRepository' shared autowired service.
     *
     * @return \Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAccountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'uvdesk'.\DIRECTORY_SEPARATOR.'core-framework'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Microsoft'.\DIRECTORY_SEPARATOR.'MicrosoftAccountRepository.php';

        return $container->privates['Webkul\\UVDesk\\CoreFrameworkBundle\\Repository\\Microsoft\\MicrosoftAccountRepository'] = new \Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAccountRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
