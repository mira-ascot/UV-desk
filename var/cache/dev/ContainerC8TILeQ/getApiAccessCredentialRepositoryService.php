 ...
 */
class getApiAccessCredentialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Webkul\UVDesk\ApiBundle\Repository\ApiAccessCredentialRepository' shared autowired service.
     *
     * @return \Webkul\UVDesk\ApiBundle\Repository\ApiAccessCredentialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'uvdesk'.\DIRECTORY_SEPARATOR.'api-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApiAccessCredentialRepository.php';

        return $container->privates['Webkul\\UVDesk\\ApiBundle\\Repository\\ApiAccessCredentialRepository'] = new \Webkul\UVDesk\ApiBundle\Repository\ApiAccessCredentialRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
