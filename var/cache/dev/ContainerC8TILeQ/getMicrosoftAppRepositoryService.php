 ...
 */
class getMicrosoftAppRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAppRepository' shared autowired service.
     *
     * @return \Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAppRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'uvdesk'.\DIRECTORY_SEPARATOR.'core-framework'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Microsoft'.\DIRECTORY_SEPARATOR.'MicrosoftAppRepository.php';

        return $container->privates['Webkul\\UVDesk\\CoreFrameworkBundle\\Repository\\Microsoft\\MicrosoftAppRepository'] = new \Webkul\UVDesk\CoreFrameworkBundle\Repository\Microsoft\MicrosoftAppRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
