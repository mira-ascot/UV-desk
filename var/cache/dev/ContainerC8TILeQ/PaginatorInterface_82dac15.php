...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer26498 && ($this->initializer26498->__invoke($valueHolder2ff5f, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer26498) || 1) && $this->valueHolder2ff5f = $valueHolder2ff5f;

        if ($this->valueHolder2ff5f === $returnValue = $this->valueHolder2ff5f->paginate($target, $page, $limit, $options)) {
            return $this;
        }
