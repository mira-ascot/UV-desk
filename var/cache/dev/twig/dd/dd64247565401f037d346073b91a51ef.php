...
class __TwigTemplate_4e0a1a4553d17e1fac8f01a8e30fe12a extends Template
{
...
\t\t\t\t";
        // line 18
        if ((($tmp = (isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 18, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 19
            yield "\t\t\t\t\t<ul>
\t\t\t\t\t\t";
            // line 20
...
\t</div>
\t{{ parent() }}
{% endblock %}", "@UVDeskSupportCenter/Knowledgebase/folder.html.twig", "/home/users/sanjeev.papnoi/www/uvdesk-community-v1.1.8/vendor/uvdesk/support-center-bundle/Resources/views/Knowledgebase/folder.html.twig");
    }
}
