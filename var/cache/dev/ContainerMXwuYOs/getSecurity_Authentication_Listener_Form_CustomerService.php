...
class getSecurity_Authentication_Listener_Form_CustomerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.listener.form.customer'])) {
            return $container->privates['security.authentication.listener.form.customer'];
        }
        ...
        $e->setOptions(['use_referer' => true, 'login_path' => 'helpdesk_customer_login', 'default_target_path' => 'helpdesk_customer_ticket_collection', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path']);
        $e->setFirewallName('customer');
        ...
        $g->setOptions(['login_path' => 'helpdesk_customer_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path']);
